...
conda activate <env>
# run the helper with bash from the repository root
bash scripts/setup_processing_tools.sh
```

Make sure to execute the script with `bash`; running it with Python will result in a `SyntaxError`.
